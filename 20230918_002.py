...
# -----------------------------------------------------------------------------------------------------------
def buy_sell_signals(df,stock,startdate,enddate):
    # print('buy_sell_signals def')  
...
# print(buy_sell_signals(df,stock,startdate,enddate))
# -----------------------------------------------------------------------------------------------------------
...
# df = get_stock_data(stock,startdate,enddate,period,interval)
# df = ma_strategy(df,long_MA,short_MA)
# df = buy_sell_signals(df,stock,startdate,enddate)
# df = backtest(df,stock,startdate,enddate, initial_wealth)
# graph(df,stock)

stocks = ['cboe','nvda','tsla']
for stock in stocks:
  df = get_stock_data(stock,startdate,enddate,period,interval)
  df = ma_strategy(df,long_MA,short_MA)
  df = buy_sell_signals(df,stock,startdate,enddate)
